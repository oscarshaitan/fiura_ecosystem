...
class _$Error implements Error {
  ...
  @override
  String toString() {
    return 'SponsorState.error(message: $message)';
  }
...
class _$ChargedImage implements ChargedImage {
  ...
  @override
  String toString() {
    return 'SponsorState.chargedImage(image: $image, name: $name)';
  }
